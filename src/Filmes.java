...
public class Filmes {
    public static void main(String[] args) {
        ...
        String filePath = "C:/Users/Giulia/Projeto Integrador Grafos/PI_GRAFOS/csv/IMDB_CSV.csv"; // Substitua pelo caminho do seu arquivo
        //String filePath = "C:/Users/Giulia/Projeto Integrador Grafos/IMDB_CSV.csv"; //pegar arquivo local
    ...
    private static void buscarMelhorAtorPorGenero(Scanner scanner, Map<String, Set<String>> grafo,
        ...
        String arquivoSaida = "C:/Users/Giulia/Projeto Integrador Grafos/PI_GRAFOS/resultados/resultado_" + generoEscolhido + ".txt";
